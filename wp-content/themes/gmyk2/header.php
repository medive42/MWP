...
<div class="wal nav" style="">
      ...
      <ul style="">
	    <li><a href="<?php bloginfo(’url’); ?>">网站首页</a></li>	
	...
	<div class="topSearch" style="right:1%;">
     <input class="input1 input_hover" type="text" name="s" value="Search" />
...
<div class="sideBar">
      <ul>
        ...
        <li><a href="javascript:;"><div><img src="<?php echo get_theme_file_uri(''); ?>/img/1.png"/></div>预约挂号</a></li>
        <li><a href="javascript:;"><div><img src="<?php echo get_theme_file_uri(''); ?>/img/2.png"/></div>近视手术</a></li>
		<li><a href="tel:123456789"><div><img src="<?php echo get_theme_file_uri(''); ?>/img/3.png"/></div>联系电话</a></li>
      </ul>
</div>